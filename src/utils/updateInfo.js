...
// 检查信息完整性
let about = mbInfo.about?.length > 0 ? mbInfo.about : [imsyyHome];
// if (!about || about.length < 1) {
//   about = [imsyyHome];
// } else {
//   if (!infoEqual(about[0], imsyyHome) || about[0].logo !== imsyyHome.logo) {
//     about = about.filter(item => item.author !== "imsyy");
//     about.unshift(imsyyHome);
//   }
// }
